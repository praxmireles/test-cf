...
class CancelledAppointmentDashboard < Administrate::BaseDashboard
  # ATTRIBUTE_TYPES
  ...
  # Overwrite this method to customize how cancelled appointments are displayed
  # across all pages of the admin dashboard.
  #
  # def display_resource(cancelled_appointment)
  #   "CancelledAppointment ##{cancelled_appointment.id}"
  # end
end
