...
class OpenAppointmentDashboard < Administrate::BaseDashboard
  # ATTRIBUTE_TYPES
  ...
  # Overwrite this method to customize how open appointments are displayed
  # across all pages of the admin dashboard.
  #
  # def display_resource(open_appointment)
  #   "OpenAppointment ##{open_appointment.id}"
  # end
end
