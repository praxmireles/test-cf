...
class CompletedAppointmentDashboard < Administrate::BaseDashboard
  # ATTRIBUTE_TYPES
  ...
  # Overwrite this method to customize how completed appointments are displayed
  # across all pages of the admin dashboard.
  #
  # def display_resource(completed_appointment)
  #   "CompletedAppointment ##{completed_appointment.id}"
  # end
end
