...
class ClosedAppointmentDashboard < Administrate::BaseDashboard
  # ATTRIBUTE_TYPES
  ...
  # Overwrite this method to customize how closed appointments are displayed
  # across all pages of the admin dashboard.
  #
  # def display_resource(closed_appointment)
  #   "ClosedAppointment ##{closed_appointment.id}"
  # end
end
