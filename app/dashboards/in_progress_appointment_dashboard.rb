...
class InProgressAppointmentDashboard < Administrate::BaseDashboard
  # ATTRIBUTE_TYPES
  ...
  # Overwrite this method to customize how in progress appointments are displayed
  # across all pages of the admin dashboard.
  #
  # def display_resource(in_progress_appointment)
  #   "InProgressAppointment ##{in_progress_appointment.id}"
  # end
end
